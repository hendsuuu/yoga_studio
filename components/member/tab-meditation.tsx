    ...
    <div className="max-w-6xl mx-auto space-y-5">
      <div className="bg-secondary text-white p-5 sm:p-6 rounded-xl shadow-lg">
        ...
        <textarea
          ...
          className="w-full bg-white/10 border border-white/20 rounded-xl p-3.5 text-sm outline-none focus:border-accent placeholder:text-white/30 min-h-[100px] mb-3.5 transition-all resize-none"
        />
        <button
          onClick={generate}
      ...
      {result && !loading && (
        <div className="bg-rose-soft rounded-xl border border-rose-light shadow-lg overflow-hidden animate-in fade-in">
          <div className="bg-white px-5 py-3 border-b border-rose-bg flex justify-between items-center">
          ...
          <div className="p-5 sm:p-6 relative">
            <Quote className="absolute top-3 left-3 w-8 h-8 text-rose-light opacity-40" />
          ...
          <button
            ...
            className="w-full py-3.5 bg-white text-stone-400 font-bold text-xs uppercase tracking-widest border-t border-rose-bg hover:bg-gray-50 transition-colors"
          >
            Selesai Sesi
          </button>
        </div>
